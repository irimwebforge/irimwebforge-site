...
const presence: Service = {
  ...
  fullDescription: 'Une solution complète pour gérer votre présence en ligne de manière autonome. Idéale pour les indépendants et thérapeutes qui veulent se concentrer sur leur métier sans dépendre d\'un prestataire technique.',
  icon: 'Laptop',
  color: 'primary',
  price: '1 500–2 200€',
  support: '70€/mois',
  ...
  seoDescription: 'Solution de site web clé en main pour indépendants et thérapeutes. Gestion autonome, formation incluse et support technique.',
