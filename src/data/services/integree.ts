...
const integree: Service = {
  ...
  fullDescription: 'Une solution intégrée qui connecte tous vos outils numériques. Parfaite pour les professionnels qui veulent automatiser leurs tâches administratives et gagner un temps précieux.',
  icon: 'Zap',
  color: 'secondary',
  price: '3 500–5 000€',
  support: '150€/mois',
  ...
  testimonial: {
    quote: "Nos équipes ont récupéré 2h par jour. Plus d'erreurs de saisie, tout est automatisé et fiable.",
    author: "Pierre D.",
    role: "Directeur d'agence"
  },

  cta: 'Je veux cette formule',
  seoDescription: 'Solution intégrée d\'automatisation pour entreprises. Connectez vos outils métier et optimisez vos processus.',
