...
const evolutive: Service = {
  ...
  shortDescription: 'Votre outil grandit avec vous. Ajoutez des fonctionnalités au fur et à mesure.',
  fullDescription: 'Une solution flexible qui évolue avec votre entreprise. Idéale pour les entrepreneurs qui veulent démarrer simplement puis ajouter des fonctionnalités selon leurs besoins.',
  icon: 'TrendingUp',
  color: 'tertiary',
  price: '2 500–4 000€',
  support: '100€/mois',
  ...
  testimonial: {
    quote: "On a commencé petit et maintenant on gère 500 clients avec le même outil. Il a grandi avec nous.",
    author: "Julie M.",
    role: "Fondatrice startup"
  },

  cta: 'Je veux cette formule',
  seoDescription: 'Solution web évolutive pour entrepreneurs. Démarrez simple et ajoutez des fonctionnalités selon vos besoins.',
