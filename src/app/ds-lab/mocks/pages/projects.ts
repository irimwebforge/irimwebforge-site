  ...
  projects: [
    {
      ...
      description:
        'Interface sur mesure pour thérapeute/artiste avec gestion simplifiée des contenus',
      image: {
    ...
    },
    {
      ...
      description:
        'Libération des coûts mensuels et dépendance technique avec interface admin intuitive',
      image: {
