...
export const BLOG_POSTS = [
  {
    ...
    excerpt: 'Découvrez les tendances émergentes qui façonnent le design web cette année, des interfaces immersives aux micro-interactions.',
  ...
  },
  {
    ...
    excerpt: 'Comment structurer vos applications web pour une performance et une scalabilité optimales tout en gardant le code maintenable.',
    coverImage: '/images/projects/project-placeholder.jpg',
  ...
  },
  {
    ...
    excerpt: 'Analyse des stratégies d\'acquisition client efficaces pour les startups B2B à budget limité.',
    coverImage: '/images/projects/project-placeholder.jpg',
...
export const COMPARISON_COLUMNS: ComparisonColumn[] = [
  ...
  { id: 'plan2', title: 'Pro', description: 'Pour les professionnels', highlight: true, color: 'secondary' },
...
export const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer: 'Pour démarrer un nouveau projet, connectez-vous à votre tableau de bord et cliquez sur le bouton "Nouveau projet". Suivez les étapes guidées pour configurer votre projet en fonction de vos besoins.',
    isOpen: true
  },
  {
    id: 'faq2',
    question: 'Quels sont les délais moyens de réalisation ?',
    answer: 'Les délais de réalisation varient selon la complexité du projet. Un site vitrine prend généralement 4 à 6 semaines, tandis qu\'une application web peut nécessiter 8 à 12 semaines. Nous établissons un calendrier détaillé lors de la phase de planification.',
    isOpen: false
  },
  {
    id: 'faq3',
    question: 'Comment fonctionne votre processus de support ?',
    answer: 'Notre support technique est disponible par email 7j/7 et par téléphone du lundi au vendredi de 9h à 18h. Les clients sur les forfaits Pro et Entreprise bénéficient d\'un support prioritaire avec des temps de réponse garantis.',
    isOpen: false
  },
  {
    id: 'faq4',
    question: 'Proposez-vous des services de maintenance ?',
    answer: 'Oui, nous proposons des contrats de maintenance adaptés à vos besoins, incluant les mises à jour de sécurité, sauvegardes régulières, corrections de bugs et assistance technique. Contactez-nous pour un devis personnalisé.',
    isOpen: false
  }
];
...
export const FEATURES: Feature[] = [
  {
    ...
    description: 'Interfaces sur mesure adaptées à votre image de marque et à vos objectifs commerciaux.',
    color: 'primary',
    link: {
      text: 'En savoir plus',
      url: '/services/design'
  ...
  },
  {
    ...
    description: 'Techniques avancées de référencement pour améliorer votre visibilité sur les moteurs de recherche.',
    color: 'tertiary',
    link: {
  ...
  },
  {
    ...
    description: 'Assistance technique disponible pour résoudre rapidement vos problèmes et questions.',
    color: 'primary',
    link: {
...
export const PROJECTS = [
  {
    ...
    description: 'Site e-commerce de produits de luxe avec interface utilisateur simplifiée et système de paiement sécurisé.',
  ...
  },
  {
    ...
    description: 'Tableau de bord analytique pour entreprises avec visualisations de données en temps réel et rapports personnalisables.',
  ...
  },
  {
    ...
    imageSrc: '/images/projects/project-placeholder.jpg',
    tags: [PROJECT_TAGS[2]],
    description: 'Application web de suivi de bien-être avec fonctionnalités de méditation, suivi d\'exercices et journal personnel.',
...
export const TAB_ITEMS: TabItem[] = [
  {
    id: 'tab1',
    label: 'Présentation',
    content: 'Notre agence web crée des expériences digitales sur-mesure pour vous aider à atteindre vos objectifs. Fondée sur des valeurs d\'expertise, de créativité et d\'innovation, nous mettons notre savoir-faire au service de votre réussite.',
    icon: undefined
  },
  {
    id: 'tab2',
    label: 'Services',
    content: 'Nous proposons une gamme complète de services digitaux, du design d\'interface à la création de sites web, en passant par le développement d\'applications, l\'optimisation SEO et les stratégies de contenu.',
    badge: 'Nouveaux',
    icon: undefined
  },
  {
    id: 'tab3',
    label: 'Réalisations',
    content: 'Découvrez nos projets les plus récents, réalisés pour des clients de tous secteurs. Chaque projet témoigne de notre approche personnalisée et de notre engagement à fournir des résultats exceptionnels.',
    icon: undefined
  }
]; 