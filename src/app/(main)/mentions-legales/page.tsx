...
export const metadata = {
  ...
  description: 'Mentions légales du site IRIM Webforge - Studio de création digitale spécialisé dans la conception d\'interfaces sur mesure.',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Typography variant="p" className="text-secondary">
                    ...
                    Responsable de la publication : Eric Zuber<br />
                    11 route de Paris<br />
                    67117 Ittenheim, France<br />
                    Téléphone : 06 78 76 45 59<br />
            ...
            <section>
              ...
              <Typography variant="p" className="text-secondary">
                Si vous constatez une lacune, erreur ou ce qui parait être un dysfonctionnement, merci de bien vouloir le signaler par email à l'adresse contact@irimwebforge.com en décrivant le problème de la façon la plus précise possible.
              </Typography>
            </section>
            ...
            <section>
              ...
              <Typography variant="p" className="text-secondary mb-4">
                Les liens hypertextes mis en place dans le cadre du présent site web en direction d'autres ressources présentes sur le réseau Internet ne sauraient engager la responsabilité de IRIM Webforge.
              </Typography>
              <Typography variant="p" className="text-secondary">
                De même, IRIM Webforge ne peut être tenu responsable du contenu des sites qui auraient un lien vers le présent site.
              </Typography>
            </section>
