...
export default function Page() {
  ...
  const VisionBanner = () => (
    ...
    >
      <p className="text-sm text-blue-800 dark:text-blue-200">
        Cette page présente ma vision des projets que j'aimerais réaliser. Elle mélange projets personnels réels 
        et projections de réalisations futures pour illustrer mon approche.
      </p>
    </Alert>
  );
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Concept d\'interface intuitive permettant à un onirologue de gérer ses contenus sans intervention technique externe. Une vision de l\'autonomie numérique que je souhaite permettre.',
      status: 'Concept'
    },
    {
      id: 'mr-mrs-cbd',
      ...
      description: 'Projet en développement visant à libérer un commerce local de ses abonnements coûteux. L\'objectif est une économie annuelle de 2640€ et une reprise de contrôle totale sur l\'évolution du site.',
    ...
    },
    {
      ...
      description: 'Application holistique de suivi de cycle menstruel en développement. Un projet personnel qui explore les possibilités d\'interfaces intuitives sur mobile avec React Native.',
      status: 'En développement'
    }
  ];
  ...
  const transformationCategories = [
    {
      ...
      description: "Comment une interface bien pensée peut transformer l'anxiété administrative en confiance",
      examples: [
    ...
    },
    {
      ...
      description: "Créer des écosystèmes numériques cohérents qui remplacent les outils disparates",
      examples: [
    ...
    },
    {
      ...
      description: "Reprendre le contrôle de sa présence en ligne sans dépendre d'un expert technique",
      examples: [
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <Typography variant="lead" className="mb-8 max-w-3xl mx-auto">
              Un mélange de projets réalisés, en cours et conceptuels qui illustrent ma vision pour mes futurs clients.
            </Typography>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <Typography variant="p" className="text-gray-600 dark:text-gray-300 text-sm">
                    Les projets sont clairement identifiés comme "Réalisés", "En développement" ou "Concepts" 
                    pour distinguer les expériences réelles des aspirations. Ils sont tous inspirés par ma 
                    vision d'interfaces qui libèrent du temps et de l'énergie.
                  </Typography>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <Container>
          <div className="text-center mb-12">
            ...
            <Typography variant="lead" className="mb-8 max-w-3xl mx-auto">
              Au-delà des aspects techniques, ce sont ces changements concrets dans votre quotidien professionnel qui m'inspirent.
            </Typography>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {transformationCategories.map((category, index) => (
              ...
              >
                <div className={`w-12 h-12 rounded-full bg-[var(--color-${category.color}-100)] dark:bg-[var(--color-${category.color}-900)] flex items-center justify-center mb-4`}>
                  <Icon name={category.icon} className={`text-[var(--color-${category.color}-700)] dark:text-[var(--color-${category.color}-300)]`} />
                </div>
                ...
                <Typography as="h4" variant="h4" className="text-sm uppercase text-gray-500 dark:text-gray-400 mb-3">
                  Exemples concrets
                </Typography>
                ...
                <ul className="space-y-2">
                  {category.examples.map((example, i) => (
                    <li key={i} className="flex items-start gap-2">
                      <Icon name="Check" className={`text-[var(--color-${category.color}-600)] dark:text-[var(--color-${category.color}-400)] mt-1 flex-shrink-0`} size={16} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8">
                ...
                <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border-l-4 border-red-500 dark:border-red-700">
                  <Typography variant="p" className="font-medium text-red-700 dark:text-red-400">AVANT</Typography>
                  <Typography variant="p" className="text-gray-800 dark:text-gray-200">
                    7 heures par semaine de lutte avec une interface générique, stress, erreurs fréquentes, et temps perdu loin de ses patients.
                  </Typography>
                </div>
                
                <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border-l-4 border-green-500 dark:border-green-700">
                  <Typography variant="p" className="font-medium text-green-700 dark:text-green-400">APRÈS</Typography>
                  <Typography variant="p" className="text-gray-800 dark:text-gray-200">
                    45 minutes d'administration sereine, mise à jour simple du planning, plus de temps pour ses patients et sa formation continue.
                  </Typography>
                </div>
                
                <Typography variant="p" className="mb-6">
                  Cette transformation concrète m'a montré l'impact qu'une interface bien conçue peut avoir 
                  sur le quotidien d'un indépendant. C'est ce type de changement que j'aimerais rendre 
                  possible pour d'autres professionnels.
                </Typography>
