  ...
  const comparisonRows: ComparisonRow[] = [
    {
      id: 'interface',
      feature: 'Adaptation',
      values: ['Vous vous adaptez à l\'interface', { value: 'L\'interface s\'adapte à VOUS', highlight: true }],
    },
    {
      id: 'complexity',
      feature: 'Simplicité',
      values: ['Navigation complexe et options inutiles', { value: 'Interface épurée sur mesure', highlight: true }],
    },
    {
      id: 'time',
      feature: 'Temps administratif',
      values: ['7h/semaine en moyenne pour les mises à jour', { value: '45min/semaine pour mêmes tâches', highlight: true }],
    },
    {
      id: 'autonomy',
      feature: 'Autonomie',
    ...
    },
    {
      id: 'cost',
      feature: 'Coût',
      values: ['Abonnements mensuels sans fin', { value: 'Investissement puis indépendance', highlight: true }],
    },
  ];
  ...
  const differenceFeatures = [
    {
      ...
      description: 'Je comprends à la fois votre réalité métier et les solutions techniques. Je pose des questions que d\'autres développeurs ne penseraient pas à poser pour comprendre votre métier au-delà de vos besoins techniques.',
    ...
    },
    {
      ...
      description: 'J\'accorde autant d\'importance à ce que vous dites qu\'à ce que vous ne dites pas. Cette capacité d\'écoute me permet de créer des solutions qui répondent à vos besoins réels, pas aux suppositions techniques.',
    ...
    },
    {
      ...
      description: 'Je prends en charge la responsabilité technique pour que vous restiez concentré sur votre cœur de métier. Vous n\'avez pas besoin de comprendre la technique pour bénéficier pleinement de votre solution digitale.',
      icon: 'Brain' as const,
  ...
  const valueFeatures = [
    {
      ...
      description: 'Reprenez le contrôle de votre présence en ligne sans dépendance technique. Mettez à jour votre site vous-même, sans crainte de "tout casser" et sans attendre un prestataire.',
    ...
    },
    {
      ...
      description: 'Passez de 7h à 45min d\'administration hebdomadaire comme l\'a fait mon épouse thérapeute. Récupérez un temps précieux pour vous consacrer à votre cœur de métier et à vos clients.',
      icon: 'Clock' as const,
      color: 'primary' as const,
    },
    {
      ...
      description: 'Une présence en ligne qui reflète véritablement qui vous êtes, pas un template standardisé. Vos valeurs et votre identité transpirent dans chaque aspect de votre site.',
    ...
    },
    {
      ...
      description: 'Des solutions qui grandissent avec vous, sans tout reconstruire. Votre présence digitale s\'adapte à l\'évolution de votre activité, sans recommencer à zéro.',
  ...
  const featuredProjects = [
    {
      ...
      title: 'Corps & Sens',
      slug: 'corps-et-sens',
      description: 'Interface sur mesure pour thérapeute/artiste permettant de gérer facilement planning, contenus et images. Un gain de temps précieux redéployé vers l\'accompagnement des patients et la créativité.',
    ...
    },
    {
      ...
      description: 'Interface de gestion intuitive pour onirologue permettant l\'ajout et la modification de contenus sans aucune intervention technique externe. Une indépendance retrouvée.',
    ...
    },
    {
      ...
      title: 'Mr&Mrs CBD',
      slug: 'mr-mrs-cbd',
      description: 'Fin de la dépendance à un système d\'abonnement coûteux (économie de 2640€/an) et reprise de contrôle total sur l\'évolution du site. Une rentabilité immédiate.',
      ...
      <section className="py-32 bg-gray-50 dark:bg-gray-900 relative">
        ...
        <TemporalSplit
          ...
          leftContent={{
            ...
            content: "Sites web personnalisés avec interfaces de gestion sur mesure. Des sites qui vous ressemblent vraiment, associés à des interfaces d'administration que vous pouvez utiliser sans compétence technique. Mon épouse est passée de 7h à 45min d'administration hebdomadaire grâce à cette approche.",
            example: {
              title: "Corps & Sens",
              highlight: "De 7h à 45min d'administration hebdomadaire",
            },
            target: "Particulièrement adapté aux thérapeutes, artisans et professionnels en transition qui cherchent à reprendre le contrôle de leur présence en ligne sans y consacrer trop de temps."
          }}
          rightContent={{
            title: "Ce que je développe pour l'avenir",
            content: "Pour étendre votre impact au-delà de votre site web. Actuellement en développement avec le projet MoodCycle, une application holistique de suivi de cycle.",
            example: {
              title: "Applications web/mobiles personnalisées",
            },
            message: "Ma vision pour les clients avec qui j'aurai établi une relation de confiance durable. Intégration fluide entre site, gestion, application, et plus encore."
          }}
          className="space-y-16"
        />
      </section>
