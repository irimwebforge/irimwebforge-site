...
export default function Page() {
  const values = [
    {
      ...
      description: 'Reprenez le contrôle de votre présence en ligne sans dépendance technique. Mettez à jour votre site vous-même, sans crainte de "tout casser".',
    ...
    },
    {
      ...
      description: 'Passez de 7h à 45min d\'administration hebdomadaire comme l\'a fait mon épouse thérapeute. Récupérez un temps précieux pour votre cœur de métier.',
  ...
  const testimonials = [
    {
      quote: "Eric a fait plus que créer un site web, il a véritablement compris mon métier et mes contraintes. Je ne perds plus mon dimanche à mettre à jour mon site. J'ai maintenant une interface simple qui me correspond et me fait gagner un temps précieux.",
      author: "Marie",
      company: "Thérapeute énergétique"
    },
    {
      quote: "Ce qui me frappe chez Eric, c'est sa capacité à comprendre mes besoins même quand je ne sais pas les exprimer clairement. Il traduit mes idées floues en solutions concrètes et intuitives.",
      author: "Thomas",
        ...
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Typography variant="p" className="mb-4">
                Mon expérience en tant que formateur m'a appris à vulgariser les concepts complexes et à écouter véritablement les besoins exprimés comme implicites.
              </Typography>
              
              <div className="flex items-center mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <Icon name="Quote" size={48} className="text-[var(--color-primary)] opacity-30 mr-4" />
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-inner">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--color-primary)] flex items-center justify-center text-white font-bold">1</div>
                  <div>
                    <Typography as="h4" variant="h4" className="mb-1">
                      Immersion dans votre métier
                    </Typography>
                    <Typography variant="p">
                      Je commence par comprendre en profondeur votre activité, vos contraintes et vos aspirations avant de parler technique.
                    </Typography>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--color-secondary)] flex items-center justify-center text-white font-bold">2</div>
                  <div>
                    <Typography as="h4" variant="h4" className="mb-1">
                      Co-création adaptée
                    </Typography>
                    <Typography variant="p">
                      Nous construisons ensemble une solution parfaitement adaptée à vos processus de travail, pas l'inverse.
                    </Typography>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-[var(--color-tertiary)] flex items-center justify-center text-white font-bold">3</div>
                  <div>
                    <Typography as="h4" variant="h4" className="mb-1">
                      Transfert progressif d'autonomie
                    </Typography>
                    <Typography variant="p">
                      Je vous accompagne jusqu'à ce que vous soyez parfaitement à l'aise pour gérer votre présence digitale en toute indépendance.
                    </Typography>
                  </div>
                </div>
              </div>
