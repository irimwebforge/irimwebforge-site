...
export const metadata: Metadata = {
  ...
  description: 'Réservez votre diagnostic numérique personnalisé gratuit de 30 minutes et découvrez comment libérer votre temps professionnel comme notre cas d\'usage : 6h récupérées par semaine.',
  keywords: 'diagnostic numérique, audit digital, consultation gratuite, optimisation digitale, automatisation, gestion du temps',
};
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Typography variant="lead" className="text-secondary mb-12">
              Un diagnostic personnalisé pour identifier précisément comment la technologie peut vous faire gagner du temps
            </Typography>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 rounded-full bg-[var(--color-primary-bg-accessible)] flex items-center justify-center">
                        <Icon name={benefit.icon as any} className="w-6 h-6 text-[var(--color-primary-accessible)]" />
                      </div>
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] flex items-center justify-center mx-auto mb-4">
                  <Typography variant="h3" className="text-white font-bold">1</Typography>
                </div>
                <Typography as="h3" variant="h4" className="mb-2 font-semibold">Échange découverte</Typography>
                <Typography variant="p" className="text-secondary">Discussion sur votre activité et vos défis quotidiens (10 min)</Typography>
              </div>
              
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] flex items-center justify-center mx-auto mb-4">
                  <Typography variant="h3" className="text-white font-bold">2</Typography>
                </div>
                <Typography as="h3" variant="h4" className="mb-2 font-semibold">Analyse en direct</Typography>
                <Typography variant="p" className="text-secondary">Évaluation de vos outils et processus actuels (15 min)</Typography>
              </div>
              
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] flex items-center justify-center mx-auto mb-4">
                  <Typography variant="h3" className="text-white font-bold">3</Typography>
                </div>
                <Typography as="h3" variant="h4" className="mb-2 font-semibold">Recommandations</Typography>
                <Typography variant="p" className="text-secondary">Conseils pratiques et plan d'action immédiat (5 min)</Typography>
              </div>
            </div>
          </div>
        </Container>
      ...
      <section className="bg-section-primary py-16">
        <Container>
          <div className="max-w-3xl mx-auto">
            <Card className="text-center" padding="large" variant="accent" color="tertiary" accentPosition="left">
              <div className="mb-6">
                <Icon name="Quote" className="w-12 h-12 text-[var(--color-tertiary-accessible)] mx-auto mb-4" />
                <Typography variant="lead" className="italic text-primary mb-4">
                  ...
                  Maintenant, 5 minutes suffisent. Elle a récupéré ses soirées et peut se concentrer sur ses patients."
                </Typography>
              </div>
