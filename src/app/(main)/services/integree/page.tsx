...
export const metadata = {
  ...
  description: 'Gestion de rendez-vous, facturation et suivi client intégrés. Tout communique naturellement pour une efficacité maximale.',
}
  ...
  return (
    <main className="overflow-x-hidden transition-all duration-300">
      <PageHeader
        ...
        size="large"
        pattern
        badge={{ text: 'Solution complète', variant: service.color }}
      />
            ...
            <Card className="p-8" variant="accent" color={service.color} accentPosition="top">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
                <div className="flex items-center gap-3">
                  <Icon name={service.icon} className="w-10 h-10 text-[var(--color-secondary)]" />
