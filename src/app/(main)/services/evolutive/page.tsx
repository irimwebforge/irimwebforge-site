        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 text-center">
              <NavLink href="/processus" className="text-[var(--color-tertiary)] hover:text-[var(--color-tertiary)] dark:hover:text-[var(--color-tertiary)] inline-flex items-center gap-2">
