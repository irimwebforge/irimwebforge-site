...
export const metadata = {
  ...
  description:
    'Politique de confidentialité du site IRIM Webforge - Protection de vos données personnelles et respect de votre vie privée.',
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <section>
              ...
              <Typography variant="p" className="text-secondary">
                IRIM Webforge s'engage à protéger votre vie privée et à traiter vos données
                personnelles de manière transparente et sécurisée. Cette politique de
                confidentialité vous informe sur la façon dont nous collectons, utilisons et
            ...
            <section>
              ...
              <Typography variant="p" className="text-secondary">
                ...
                <br />
                Adresse : 11 route de Paris, 67117 Ittenheim, France
                <br />
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Typography variant="p" className="text-secondary">
                    Lorsque vous nous contactez via le formulaire de contact ou par email, nous
                    collectons :
                  </Typography>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 text-secondary">
                <li>
                  <strong>Votre consentement</strong> : pour les demandes de contact
                </li>
                <li>
                ...
                <li>
                  <strong>L'exécution contractuelle</strong> : pour la fourniture de nos services
                </li>
                <li>
                  <strong>Les obligations légales</strong> : pour la conservation de certaines
                  données
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 text-secondary">
                <li>
                  <strong>Demandes de contact</strong> : 3 ans maximum
                </li>
                <li>
                  <strong>Données de navigation</strong> : 13 mois maximum
                </li>
                <li>
                  <strong>Données clients</strong> : durée de la relation commerciale + 5 ans
                </li>
                <li>
            ...
            <section>
              ...
              <Typography variant="p" className="text-secondary">
                Nous ne vendons, n'échangeons et ne transférons pas vos données personnelles à des
                tiers, sauf :
              </Typography>
              <ul className="list-disc list-inside mt-2 space-y-1 text-secondary">
                <li>Avec votre consentement explicite</li>
                <li>
                  À nos prestataires techniques (hébergement, outils de développement) sous contrat
                  de confidentialité
                </li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 text-secondary">
                ...
                <li>
                  <strong>Droit d'effacement</strong> : supprimer vos données sous certaines
                  conditions
                </li>
                <li>
                ...
                <li>
                  <strong>Droit d'opposition</strong> : vous opposer au traitement pour motifs
                  légitimes
                </li>
                <li>
              ...
              <Typography variant="p" className="text-secondary mt-4">
                ...
                <strong>contact@irimwebforge.com</strong>
              </Typography>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1 text-secondary">
                ...
                <li>
                  <strong>Analytics</strong> : pour améliorer l'expérience utilisateur (anonymisés)
                </li>
              </ul>
              <Typography variant="p" className="text-secondary mt-4">
            ...
            <section>
              ...
              <Typography variant="p" className="text-secondary">
                Nos données sont hébergées au sein de l'Union Européenne. Si des transferts vers des
                pays tiers sont nécessaires, ils s'effectuent uniquement vers des pays offrant un
                niveau de protection adéquat ou avec des garanties appropriées.
              </Typography>
            </section>
            ...
            <section>
              ...
              <Typography variant="p" className="text-secondary">
                Cette politique de confidentialité peut être mise à jour occasionnellement. Nous
                vous informerons de tout changement significatif par email ou via une notification
                sur notre site.
              </Typography>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 space-y-2 text-secondary">
                ...
                <Typography variant="p">
                  <strong>Courrier :</strong> IRIM Webforge, 11 route de Paris, 67117 Ittenheim,
                  France
                </Typography>
              </div>
