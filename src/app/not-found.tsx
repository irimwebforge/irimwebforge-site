        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="mb-8 flex justify-center">
            <div className="p-4 rounded-full bg-primary-100 dark:bg-primary-900">
              <Icon name="Search" className="w-12 h-12 text-primary animate-pulse" />
            </div>
          </div>

          <Typography as="h1" variant="h1" className="mb-4 font-bold animate-fade-in">
            Page non trouvée
          </Typography>
          ...
          >
            <Button href="/" variant="gradient" className="shine-effect w-full sm:w-auto">
              Retour à l'accueil
            </Button>
